...
-(void) initsubview{
    ...
    _DetailLabel = ({
        ...
        _DetailLabel.text = @"直到iPhone6发布之后 我知道使用autolayout势在必行了 这时想起了以前在浏览Github看到过的一个第三方库Masonry 在花了几个小时的研究使";
        [SettingLabel setLabel:_DetailLabel andSize:13.0 andColor:[UIColor lightGrayColor] andIsBold:NO];
